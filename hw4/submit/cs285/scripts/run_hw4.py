    ...
    for itr in range(config["num_iters"]):
        ...
        for _ in tqdm.trange(
            ...
            for i in range(mb_agent.ensemble_size):
                newsample = replay_buffer.sample(config["train_batch_size"])
                obs, acs, next_obs= newsample["observations"], newsample["actions"], newsample["next_observations"]
...
def main():
    ...
    parser.add_argument("--num_render_trajectories",
                        "-nvid", type=int, default=0)
